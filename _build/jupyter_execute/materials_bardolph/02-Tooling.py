...
- **CL1** due tonight (11:59 PM)
    ...
    - may be submitted by Friday Week 2 (April 9)
- **A1** will be released by Friday (due Mon of Week 3)
- **Q&A**

**Q&A**

Q: What is Datahub? What is a Jupyter notebook?  
A: That should become clear after today's Coding Lab and lecture!

Q: Why so many websites/tools? Will we use Canvas?  
A: I'm migrating my class to [the website](https://cogs18.github.io) to better integrate with Prof. Ellis's class. I still like Canvas, but it is largely redundant (reminding you of deadlines, links to other content) - still the only place to store grades!
...
Q: When is the final project/final exam?  
A: They will both be due on Friday of finals week.

Q: Is it final project OR final exam? Can we submit both?  
A: Only one! You will only complete & submit one (your choice).
...
Once you've logged into datahub, click on the the following link: https://datahub.ucsd.edu/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2FCOGS18%2FLectureNotes-Sp21-Bardolph&urlpath=tree%2FLectureNotes-Sp21-Bardolph%2F&branch=main
...
Last quarter: 24 out of 300 exams flagged for Academic Integrity violations

- Students felt regret
- All exam scores were delayed
- Investigation is ongoing (typically can take time to resolve)
