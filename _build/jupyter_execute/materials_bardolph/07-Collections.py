...
- CL3 this Wednesday, due same day (11:59 PM)
- A2 released, due next Monday

**Q&A**

Q: When code doesn't have an error, but doesn't have an output, how do we know if it's correct?  
A: In many cases, you can think of a way to check/test your code! Often, a `print` statement is helpful. You may always add an extra code block inside of Coding Labs, assignments, and exams to do this.

Q: When do we need to use colons in code?  
A: So far, we have used the colon as part of the syntax for conditionals (if/elif/else). Syntax like colons is how Python knows what you want your code to do. We will also use colons with loops!  

Q: Could we use if/elif/else to write a simple game, like a dice rolling game?  
A: Yes! It's great to think about applications like this. Conditionals can be part of a larger code structure and could help you program a game with different possible outcomes.  
