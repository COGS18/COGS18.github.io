...
- **A1** is now available, due Mon April 12 (Week 3)
- All assignments released and submitted through Datahub
- **Q&A** notes from [lecture participation survey](https://forms.gle/y4gY4DYTq9aFSkC76)

**Q&A**

Q: What is the difference between Datahub and Anaconda?  
A: Datahub is where you will access & submit all assignments. Anaconda is a way for you to run Python and edit Jupyter notebooks on your computer - Any files you work with in Anaconda's Jupyter Notebooks are saved & accessed on your own computer (not visible to Datahub).  

Q: Why can't I find my assignment/coding lab files on Anaconda?  
A: You need to use Datahub for all assignments/coding labs. You can use Anaconda's Jupyter Notebooks to save and work on files, but to turn in work for the class it must be uploaded to Datahub.  

Q: Some poll questions are confusing because I don't understand the content.  
A: Sometimes the in-class polls are meant to check your understanding of what was just introduced. Other times, they will ask you to try something new! Don't worry if you're unable to answer some questions. However, if you are consistently lost/confused, you should probably start coming to office hours to work through your questions.  
