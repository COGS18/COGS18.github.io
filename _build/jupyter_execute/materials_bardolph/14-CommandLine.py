...
To use the terminal in datahub, from the home page (Files) click on New --> Terminal
...
!ls /Users/meganbardolph/Documents/Cogs18_SP21/Lectures
...
# relative path
# this is specific to my computer
!ls ../../Cogs109_WI21/Handouts


- `..` specify you want to move one directory up in your hierarchy
- `COGS109_WI21/Handouts` specifies the path to the directory I want to list files in
...
# remember that if you're in a terminal window on your computer, the ! is omitted
# pwd
