...
- Prof Ellis' Office Hours Monday of Finals Week (1-3 PM)
    ...
    - project questions only (no exam questions)
    - first come, first serve
    - come with a specific question
    - please, if you're going to cancel, do so early so someone else can take your spot
...
- **Scripts**: a Python file for executing a particular task
    - when executed, code does something start to finish
    - file ends in `.py`
