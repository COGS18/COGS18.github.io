...
Note that Loops 3 is more complex than what will be on the midterm, but if you understand that loop in detail, you likely have a very solid understanding of loops.