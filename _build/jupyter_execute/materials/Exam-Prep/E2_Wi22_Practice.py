...
# 
# This is the second practice exam for Winter 2022. It covers topics through the Classes Lecture.
# 
...
# 
# Consider the function provided below and then debug (you can edit the code provided directly or copy and paste below so you still have the original if needed) to accomplish the task specified above. 
# 
