...
We're going to define a few functions that return booleans. (Note that this is mostly for review; these specific type questions are not on the second Exam, but mastery here ensures that you understand these concepts.)
