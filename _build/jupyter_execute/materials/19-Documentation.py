...
Note: If you use an IDE (Spyder, etc) for your final project and it inserts docstrings with slightly different format, that is OK (you don't need to change the format so long as inputs, outputs, and descrption are included)
