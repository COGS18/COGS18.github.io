...
**Notes**
- CL5 and mid-course survey EC scores posted
- A4 now available (due *next* Friday)
    - can already complete Part 1
    - Parts 2 & 3 after this set of notes
    - *recommended* to complete Parts 1 & 2 before E2
- Next week:
