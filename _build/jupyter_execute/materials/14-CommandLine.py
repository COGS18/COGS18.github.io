...
- A4 "due" (last accepted for full credit) tonight (11:59 PM)
- CL7 due Wed

**Looking Forward**
- CL8 due *next* Wednesday 
- A5 released Wed; due *next* Friday
- Final Project/Exam due Mon 3/15 (11:59 PM)


Concepts through the rest of the course: command line, modules/scripts, scientific computing, code testing/style/documentation
...
- `COGS108/Lectures-Wi21` specifies the path to the directory I want to list files in
