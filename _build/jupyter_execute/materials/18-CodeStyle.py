...
**Notes**
- E2 & CL7 Scores Posted

**E2**
- Class median: 10.95/12.5 (87.6%)
- Class mean: 10.3/12.5 (82.4%)
...
- Classes (Q8 & Q9): 
    ...
    - not testing out the `class` created
...
`pylint` is available from Anaconda to check this for you. (Not installed on datahub.)

# to download on datahub
