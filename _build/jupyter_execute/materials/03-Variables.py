<center><img src="img/hack.py.png" width="350px"></center>
...
- CL1 grades posted
    - Check Canvas for score: (2 points is full credit)
    - Because this is the first time and everyone is new to this system, you have until tonight (Fri 11:59 PM) to submit CL1
    - Typically, there are no late submissions for coding labs or exams (only for assignments)
