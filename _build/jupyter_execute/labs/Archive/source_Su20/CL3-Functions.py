...
# 
# Below is an example, with an answer for the first listed task. Below that you will be asked to sketch out your own example.
...
# 
# After brainstorming, include a sketch of your pseudocode for at least one of the tasks you brainstormed about earlier (in groups) here:
