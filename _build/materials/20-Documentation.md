...
**neurodsp**: [neurodsp](https://neurodsp-tools.github.io/neurodsp/index.html), docsite, as well as the source code (with comments), on [GitHub](https://github.com/neurodsp-tools/neurodsp).
