...
{:.text-content}
Introduction to Python is currently running for Spring Quarter 2019, for which you can check out the current [syllabus](../assets/intro/syllabus_Sp19.pdf) and [schedule](../assets/intro/schedule_Sp19.pdf). Course lectures are recorded and are publicly available as screencasts from [here](https://podcast.ucsd.edu/?q=COGS18).
